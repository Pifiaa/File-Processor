...
DB_CONNECTION := root:@/aynn-invoicings?parseTime=true

# Nombre del ejecutable
BINARY_NAME=AYNN-INVOICINGS
...
migrate-up:
	cd $(MIGRATION_DIR) && goose mysql "$(DB_CONNECTION)" up


# Este comando elimina todas las tablas de la base de datos utilizando migraciones.
migrate-down:
	cd $(MIGRATION_DIR) && goose mysql "$(DB_CONNECTION)" reset
